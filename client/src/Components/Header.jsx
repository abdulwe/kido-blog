...
import { TextInput,Button, Navbar, NavbarBrand, NavbarToggle, NavbarCollapse, NavbarLink, navbarTheme, NavbarContext } from 'flowbite-react';
...
export default function Header() {
  ...
  <span className="font-semibold text-md dark:text-white">Kido Blog</span>
      ...
      <NavbarCollapse>
        ...
        <NavbarLink as={Link} to="/Project" active = {location.pathname === '/Project'}>
          Project
        </NavbarLink>
      </NavbarCollapse>
    </Navbar>
